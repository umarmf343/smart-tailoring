...
> Migrations now seed a default super admin so you can sign in immediately after `php migrate.php run`.
...
If you prefer to set your own password before running the migrations, update the hash below and re-run:

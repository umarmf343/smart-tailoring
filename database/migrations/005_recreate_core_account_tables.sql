-- Migration: 005_recreate_core_account_tables
-- Purpose: Ensure core account tables exist for environments where earlier migrations were skipped or tables were dropped
-- Notes:
--   - Uses CREATE TABLE IF NOT EXISTS to avoid conflicts if tables already exist
--   - Mirrors schemas from 003_create_tailors_table and 004_create_customers_table
